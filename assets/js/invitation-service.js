// MeeladPulse Secure Invitation Token Service
 ...
 * Stores only the SHA-256 hash inside Firestore collection `userInvitations`.
 */
...
export async function activateInvitation(rawToken, enteredEmail, password) {
  ...
  // 3. Create actual Firebase Email & Password user account
